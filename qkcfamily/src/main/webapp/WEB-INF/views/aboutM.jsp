		...
		<div style="display: flex;">
			...
			<h1> <회사소개> </h1>
				<article class="wrap introWrap">
					<img class="intro" alt="회사소개" src="resources/imgs/intro4.png">
					<img class="intro" alt="회사소개" src="resources/imgs/intro3.png">
					<img class="intro" alt="회사소개" src="resources/imgs/intro2.png">
					<img class="intro" alt="회사소개" src="resources/imgs/intro.png">
					<img class="intro" alt="회사소개" src="resources/imgs/NORPAC.png">
					<img class="intro" alt="회사소개" src="resources/imgs/PAKSENSE.png">
				<br>		
				</article>
			</section>
