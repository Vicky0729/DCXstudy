	...
	<div class="container">
		<div class="location">
			<ul class="wrap">
				...
				<li><a href="contactUs.do">Contact Us<i class="irCommon"></i></a>
					<ul>
					<li><a href="aboutM.do">About Us</a></li>
					<li><a href="productsM.do">Products</a></li>
					<li><a href="#.jsp">News</a></li>
				...
				<li ><a href="contactUs.do">Contact<i class="irCommon"></i></a>
					<ul>
						<li><a href="">연락처/메일</a></li>
						<li><a href="">오시는길</a></li>
		...
		<div style="display: flex;">
			...
			<section>
				...
				<article class="wrap introWrap">
					<img class="coninfo" alt="연락방법" src="resources/imgs/contact1.png">		
				</article>
			</section>
